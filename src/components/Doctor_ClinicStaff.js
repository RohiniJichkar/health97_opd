...
import { Container, Switch, Select, FormControl, InputLabel, Radio, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, TextField, Typography, Button, Table, TableContainer, TableBody, TableCell, TableHead, InputBase, TableRow, TablePagination, Grid, Paper, Link, Slide } from "@material-ui/core";
...
function createData(uid, name, mobile,) {
    return { uid, name, mobile };
}
...
export default function DoctorClinicStaff() {
    ...
    const [selectedcategory, setSelectedCategory] = React.useState("Gynecologist");
            ...
            >
                <Grid item xs={12}>
                    <Typography variant="h5" noWrap={true}
                        ...
                        Clinic Staff
                        <Button className={classes.btnregister} onClick={handleClickOpenmodal} style={{ float: 'right', marginRight: 20, width: '200px', fontFamily: 'Poppins', fontSize: 12.5, fontWeight: 400 }}>New Staff Registration</Button>
                    </Typography>
                </Grid>
                            ...
                            <Grid container>
                                <Grid item xs={6} style={{ borderRight: '1px solid #F0F0F0' }}>
                                    <center>
                                        <div>
                                            ...
                                            <TextField className={classes.inputFields} type="password" id="outlined-basic" size="small" label="Password" variant="outlined" />
                                ...
                                <Grid item xs={6}>
                                    <center>
                                        ...
                                        <div >
                                            <TextField className={classes.inputFields} id="outlined-basic" label="Education" variant="outlined" size="small" />
                                ...
                                <Grid container>
                                    ...
                                    <Grid xs={12} sm={6}>
                                        <Button className={classes.btnCancle} onClick={handleClosemodal} autoFocus style={{ float: 'left', marginLeft: 20 }}>
                                            Submit
                                        </Button>
                                    </Grid>
                                </Grid>
